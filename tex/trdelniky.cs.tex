...
\usepackage{hyperref}
\usepackage{lipsum}
\title{Historie trdelníků}
\begin{document}

% nechceme používat aktivní znak -, dělá to problém v příkazu \hyperref, když se odkazujeme na label co obsahuje spojovník
\shorthandoff{-}
...
Tento web se zabývá historií trdelníků, druhu tradičního pečiva původně pečeného na dřevěném válci nad otevřeným ohněm. Popisuje různé typy trdelníků a jejich historický vývoj v středoevropském prostoru od středověku až po současnost, a uvádí zdroje receptů z tištěných kuchařek, národopisných pramenů a archivních materiálů. Cílem je poskytnout komplexní přehled o této kulinářské tradici střední Evropy.
Web je stále ve výstavbě, v současnosti obsahuje především chronologickou \hyperref[chap:bibliografie]{anotovanou bibliografii}, ve které shromažďujeme veškerou literaturu týkající se vývoje trdelníků.
\end{abstract}
...
\chapter{Online diskuze}
\label{chap:diskuze}
\input{cs/diskuze.tex}

\chapter{Bibliografie}
\label{chap:bibliografie}

\input{cs/bibliography.tex}
